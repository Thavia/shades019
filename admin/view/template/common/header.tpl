...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php }?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="http://www.websumare.com.br/images/logo.png" width="28%" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="https://www.websumare.com" target="_blank">Central do Cliente</a></li>
        <li><a href="http://www.websumare.com.br/termos-de-uso.html" target="_blank">Termos de uso</a></li>
        </ul>
    </li>
