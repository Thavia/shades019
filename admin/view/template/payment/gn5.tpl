...
<li role="presentation"><a href="#cartao" aria-controls="cartao" role="tab" data-toggle="tab">Cart&otilde;es</a></li>
...
<?php if ($campo['custom_field_id'] == $gn5_fiscal) { ?>
...
<option value="0" selected="selected">Cliente digita manual</option>
<?php foreach ($campos as $campo) { ?>
<?php if ($campo['custom_field_id'] == $gn5_numero) { ?>
<option value="<?php echo $campo['custom_field_id']; ?>" selected="selected"><?php echo $campo['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $campo['custom_field_id']; ?>"><?php echo $campo['name']; ?></option>
<?php } ?>
...
<tr>
<td>Zona</td>
<td><select class="form-control-pagseguro" name="gn5_geo_zone_id">
...
<table>
<tr>
<td width="200">Status Aguardando Pagamento</td>
...
<table>
<tr>
<td width="200">Ativar Cart&atilde;o</td>
