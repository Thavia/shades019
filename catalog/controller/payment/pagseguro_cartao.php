...
class ControllerPaymentPagseguroCartao extends Controller {
	...
	public function transition() {
		...
		$data['creditCardHolderAreaCode'] = substr(preg_replace('/[^0-9]/', '', $order_info['telephone']), 0, 2);
		$data['creditCardHolderPhone'] = substr(preg_replace('/[^0-9]/', '', $order_info['telephone']), 2);
