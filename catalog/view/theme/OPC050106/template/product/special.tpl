        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <div class="row category_filter">
                <div class="col-md-4 btn-list-grid">
                    <div class="btn-group">
                        <button type="button" id="list-view" class="btn" data-toggle="tooltip"
                                title="<?php echo $button_list; ?>"></button>
                        <button type="button" id="grid-view" class="btn" data-toggle="tooltip"
                        ...
                        <div class="caption">
                            <h4>
                                ...
                                <a href="<?php echo $product['href']; ?>"
                                   title="<?php echo $product['name']; ?>"><?php echo substr($product['name'], 0, 15)."..."; ?></a>
                                <?php } else { ?>
                            ...
                            <?php
                                    ...
                                    $preco_numero1 = str_replace(',','.',str_replace('.','', str_replace($moeda_da_loja,"",strip_tags($price))));

                                    } else {

                                    $preco_numero1 = str_replace(',','.',str_replace('.','', str_replace($moeda_da_loja,"",strip_tags($special))));

                                    } ?>


                            <?php if ($products['estoque'] > 0 ){ ?>
                            <div class="cart">
                                <button type="button"
...
echo "<p class='alert alert-danger'>Produto Esgotado </p>";
