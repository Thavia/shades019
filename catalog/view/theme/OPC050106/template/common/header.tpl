...
<meta name="athor" content = "Web Sumaré Soluções Avançadas" />
<?php } ?>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.3&appId=613160578746345";
  ...
  <div class="container">
    <div class="row">
	 ...
	 <div class="col-sm-12">
        <div id="logo">
          <?php if ($logo) { ?>
          <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" width="277px" /></a>
          <?php } else { ?>
