  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="telephone" value="" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="form-control" onkeypress="return txtBoxFormat(this, '(99) 99999-9999',event)" maxlength="15"/>
      </div>
      <div class="form-group required">
        <label class="control-label" for="input-payment-fax"><?php echo $entry_fax; ?></label>
        <input type="text" name="fax" value="" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control" onkeypress="return txtBoxFormat(this, '(99) 99999-9999',event)" maxlength="15"/>
      </div>
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        <label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
        <input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" <?php echo $custom_field['atribute']; ?> />
      </div>
      <?php } ?>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" onkeypress="return txtBoxFormat(this,'99.999-999',event)" maxlength="10" />
      </div>
...
$.ajax({
    ...
    dataType: 'json',
    beforeSend: function() {
      $('#postcode').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
    },
    complete: function() {
      $('.fa-spin').remove();
    },
...
$('#input-payment-postcode').trigger('change');



	$.ajax({
		url: 'index.php?route=checkout/checkout/country&country_id=30',
		dataType: 'json',
		beforeSend: function() {
