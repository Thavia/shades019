...
$('#shipping-postcode-required').on('change', function () {
...
$.ajax({
    ...
    success: function(response) {
      ...
      $('#input-shipping-address-1').val(response.logradouro);
      $('#input-shipping-address-2').val(response.bairro);
      $('#input-shipping-city').val(response.localidade);
     ...
     console.log(estado);
      ...
      $('#input-shipping-zone').val(estado);
...
$('#payment-shipping-required').trigger('change');
