		...
		if ($product_info) {
			...
			if ($product_info['quantity'] <= 0) {
				...
				$data['stock'] = $this->language->get('text_instock');
                        ...
                        $data['estoque'] = $product_info['quantity'];

$this->load->model('catalog/parcelas');
$data['price_formatado'] = $this->model_catalog_parcelas->getValor($this->request->get['product_id']);
