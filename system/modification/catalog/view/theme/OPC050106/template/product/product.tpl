 ...
 <?php } else { ?>
        ...
        <div class="<?php echo $class;?> right">
          ...
          <ul class="list-unstyled">
            ...
            <?php } ?>
<?php echo isset($price_formatado)?$price_formatado:''; ?>
            <?php if ($tax) { ?>
...
<div class="panel-heading">Calcular Frete e Prazos</div>
<div class="panel-body">
<div class="input-group">
<input type="hidden" id="id_produto_frete" name="id_produto_frete" value="<?php echo $product_id; ?>">
<input type="text" class="form-control" name="cep" id="cep" onkeypress="mascaraCampos(this, '#####-###')" maxlength="9" placeholder="000000-000">
<span class="input-group-btn">
<button class="btn btn-info" id="botao-cep" onclick="calcular_frete_ok()" type="button">OK</button>
</span>
</div>
<div id="resultado-frete"></div>
           ...
           <?php }
            ...
            echo '<div class="alert alert-danger"><i class="fa fa-tachometer"></i> Produto Esgotado! Entre em contato conosco e solicite-o sob encomenda!</div>';
				...
				<div class="<?php if ($productCount >= $sliderFor){?>slider-item<?php }else{?>product-items<?php }?>">
					...
					<div class="caption">
					 <?php if ($product['rating']) { ?>
					  ...
					  <?php } ?>
					  <h4><?php if (strlen($product['name']) > '15') { ?>
